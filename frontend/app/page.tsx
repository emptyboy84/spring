...
export default function Home() {
   ...
   const [searchedName, setSearchedName] = useState(""); // 💡 검색 성공 시점의 회사 이름을 여기에 딱 고정합니다!
      ...
      <main className="p-10 font-sans min-h-screen bg-gray-50 text-black relative">
                  ...
                  <table className="w-full text-left border-collapse">
                     <thead>
                        <tr className="bg-gray-100 text-gray-700">
                           <th className="p-4 border-b font-semibold">회사 이름</th>
                           <th className="p-4 border-b font-semibold">사업자번호</th>
                           <th className="p-4 border-b font-semibold">영업 상태</th>
                           <th className="p-4 border-b font-semibold text-center">상세</th>
                        </tr>
                     </thead>
                     <tbody>
                        <tr
                        ...
                        >
                           ...
                           <td className="p-4 border-b font-medium text-gray-800">{searchedName || "이름 미상"}</td>
         ...
         {selectedDetail && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
               <div className="bg-white p-8 rounded-lg shadow-2xl w-96 transform transition-all">
                  ...
                  <div className="space-y-3 text-sm text-gray-700">
                     ...
                     <p className="flex justify-between items-center">
                        <span className="font-semibold text-gray-500">회사 이름</span>
